...
export default function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (json.success) {
      ...
      setMessage("Enter Valid Credentials. Make sure your password contains 5 characters of any type.");
    }
  };
          ...
          <div className="container h-100">
            <div className="row d-flex justify-content-center align-items-center h-100">
              <div className="col-12 col-md-8 col-lg-6 col-xl-5">
                <div className="card" style={{ width: "90%", marginTop: "20px", borderRadius: "15px", backgroundColor: "rgba(255, 255, 255, 0.4)" }}>
                  <div className="card-body p-4">
                    ...
                    <form onSubmit={handleSubmit}>
                      <div className="row">
                        <div className="col-md-6 mb-3">
                          <div className="form-outline">
                            <label className="form-label text-dark" htmlFor="form3Example1cg">First Name</label>
                        ...
                        <div className="col-md-6 mb-3">
                          <div className="form-outline">
                            <label className="form-label text-dark" htmlFor="form3Example2cg">Last Name</label>
                      ...
                      <div className="form-outline mb-3">
                        <label className="form-label text-dark px-3" htmlFor="form3Example3cg">Select User Type</label>
                      ...
                      {message && <p className="text-center text-dark mt-3">{message}</p>}
                      <p className="text-center text-muted mt-4">Already have an account? <Link to="/login" className="fw-bold text-warning"><u>Login here</u></Link></p>
                    </form>
                  </div>
                </div>
              </div>
